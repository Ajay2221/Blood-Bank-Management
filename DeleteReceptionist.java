			      ...
			      try
			       {
			         int foundrec = 0;
		 					...
		 					conn = DriverManager.getConnection("jdbc:mysql://localhost/Blood_Donation","root","root123");
			 ...
			 {//delete
			 	if(((t1.getText()).equals(""))&&((t2.getText()).equals("")))
			     {
			      ...
			      try
			       {
			    Class.forName("com.mysql.jdbc.Driver");
				conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/Blood_Donation","root","root123");
				System.out.println("Connected to database.");
